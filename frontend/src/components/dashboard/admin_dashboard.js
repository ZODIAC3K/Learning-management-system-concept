...
function Admin_dashboard() {
  // console.log(data); // checking if data is coming into front end or not!!
  return (
    <React.Fragment>
    {/* NEED FIXING BELOW !! */}
            ...
            <div className=' md:h-[88vh] w-2/6 md:w-2/6 lg:w-1/6 flex flex-col items-center justify-between md:border-r-2'>
              <div className='flex flex-col items-center'>
                <img src={user_img} className='w-[6rem]   border-[#F9C041] rounded-full mt-8 mb-4'></img>
                  ...
                  <div className='flex flex-col'>
                    <label className='lg:text-lg text-sm font-bold text-gray-700'>Admin ID: <span className='font-normal text-md italic  text-[#F9C041]'>{data.reg_no}</span></label>
