...
import Rulebook from '../table/rulebook'
...
import Food from '../table/food'
import Suggestion from '../table/suggestion'
...
function Dashboard() {
  ...
  useEffect(() => {
    ...
    switch (true) {
      ...
      //   setBack('/dashboard/student_dashboard');
      //   break;
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/food':
        setHeading('Student');
        setUsertype('Student');
        setAttendance(<Food />);
        setBack('/dashboard/student_dashboard');
        break;
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/rulebook':
        setHeading('Student');
        setUsertype('Student');
        setAttendance(<Rulebook />);
        setBack('/dashboard/student_dashboard');
        break;
      ...
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/notice':
        ...
        setBack('/dashboard/student_dashboard');
        break;
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/suggestion':
        setHeading('Student');
        setUsertype('Student');
      ...
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/support':
        ...
        setSupportstatus('hidden')
        break;
      case URL_NAME.toLowerCase() === '/dashboard/student_dashboard/event':
        setHeading('Student');
        setUsertype('Student');
        setEvent(<Event />);
        setBack('/dashboard/student_dashboard');
